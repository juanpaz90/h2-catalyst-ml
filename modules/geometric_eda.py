...
def perform_geometric_eda(pt_tensor):
    ...
    plt.title("Distribution of Bond Lengths (Existing Edges)", fontweight="bold")
    plt.xlabel("Distance (Angstroms Å)", fontweight="bold")
    plt.ylabel("Frequency (Edge Count)", fontweight="bold")
    plt.legend()
    ...
    plt.title("System-wide Connectivity (Average Node Degree)", fontweight="bold")
    plt.xlabel("Average Neighbors per Atom", fontweight="bold")
